    ...
    <div class="modal-overlay" v-if="deleteModal" @click.self="annulerSuppression()">
      <div class="modal small-modal">
        ...
        <div class="modal-body">
          <p>Voulez-vous vraiment supprimer ce bon de réception en brouillon ?</p>
          <p v-if="toDelete"><strong>Id:</strong> {{ toDelete.id }} — <strong>Fournisseur:</strong> {{ toDelete.fournisseurNom || toDelete.fournisseurId }}</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    async confirmerSuppression() {
      try {
        await receptionApi.supprimer(this.toDelete.id)
