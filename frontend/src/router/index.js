...
const routes = [
  ...
  // ── Modules 11-16 ─────────────────────────────────────────────────────────
  { path: '/inventaires', component: InventairesPage,
  ...
  { path: '/tracabilite', component: TracabilitePage,
    meta: { requiertAuth: true, roles: ['ADMIN','AUDITEUR'] } },
  { path: '/commandes-fournisseurs', component: CommandesFournisseursPage,
    meta: { requiertAuth: true, roles: ['ADMIN','GESTIONNAIRE'] } },

  // ── Module 17 — Emplacements (MAGASINIER peut consulter) ──────────────────
  { path: '/emplacements', component: EmplacementsPage,
    meta: { requiertAuth: true, roles: ['ADMIN','GESTIONNAIRE','MAGASINIER'] } },
